...
import org.example.apothekeBestellungService.ProduktList;
...
import org.example.apothekeBestellungService.utils.BenutzerUmfrage;
...
public class Apotheke implements BestellService {
    ...
    public void bestellungAufgeben(Warenbestand warenbestand, Warenkorb warenkorb) {
        ...
        if (BenutzerUmfrage.userAuswahlJaOderNein(scanner, "Wollen Sie etwas bestehlen y/n")) {
